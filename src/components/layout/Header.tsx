...
export function Header() {
  ...
  return (
    <header className="mb-8 flex flex-col items-start justify-between gap-6 border-b pb-8 md:flex-row md:items-center">
      <div className="space-y-2">
        ...
        <nav className="flex items-center gap-4 text-sm font-medium pt-2">
            <Link 
              href="/" 
              className={cn(
            ...
            <Link 
              ...
              className={cn(
                "transition-colors hover:text-primary",
                pathname === "/notes" ? "text-foreground font-bold" : "text-muted-foreground"
              )}
            >
              All Notes
            </Link>
